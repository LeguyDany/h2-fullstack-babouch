...
<body>
    ...
    <main>
        ...
        <!-- NOUVEAUTÉS -->
        <div id="nouveautes">
            <p>Nouveautés . <span id="4">4</span></p>
        </div>
        ...
        <section class="grille">
            ...
            <div class="grid-item">
                <h1>Nike Dunk</h1> 
                <h2> Conçue initialement pour les parquets de basketball, la Nike Dunk s'impose comme la silhouette incontournable de 2021. Ses nombreux coloris permettent une multitude d'outfits originaux.</h2>
                <a href="#1" title="Decouvrir">Découvrir</a>
